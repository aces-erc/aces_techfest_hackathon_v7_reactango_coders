  ...
  const sections = [
    {
      ...
      description:
        "We work to improve healthcare access and advocate for healthier lifestyles to create a sustainable and just society.",
      image: health, 
    },
    {
      title: "Better Environment",
      description:
        "We aim to preserve and restore natural ecosystems by collaborating with stakeholders for a greener future.",
      image: environment,
    },
    {
      title: "Reduce Pollution",
      description:
        "Our mission is to tackle pollution through innovative solutions and sustainable practices.",
      image: pollution,
    },
  ];
  return (
    <div className="flex flex-col items-center justify-center border h-full w-full pt-20">
      ...
      <div className="flex flex-wrap justify-center gap-6 w-full py-10 bg-white">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg max-w-sm">
          <h3 className="text-3xl font-bold text-green-600 mb-2">2000+ kg of waste collected</h3>
          <p className="text-gray-800 font-medium">
            We as a team have been able to collect more than
            2000kg of waste from different parts of the country.
          </p>
        </div>

        {/* Card 2 */}
        <div className="bg-white p-6 rounded-lg shadow-lg max-w-sm">
          <h3 className="text-3xl font-bold text-green-600 mb-2">150+ numbers of employees</h3>
          <p className="text-gray-800 font-medium">
            We have been able to generate more than 150+ employment opportunities for the community.
          </p>
        </div>

        {/* Card 3 */}
        <div className="bg-white p-6 rounded-lg shadow-lg max-w-sm">
          <h3 className="text-3xl font-bold text-green-600 mb-2">Over 50+ places of Nepal</h3>
          <p className="text-gray-800 font-medium">
