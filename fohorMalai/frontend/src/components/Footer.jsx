...
const Footer = () => {
  return (
    <footer className="bg-gray-800 p-2 text-gray-300 ">
      <div className="container mx-auto flex flex-wrap items-center justify-evenly">
        ...
        <div className="w-full md:w-1/3 mb-6 md:mb-0 md:text-left">
          <h1 className="text-3xl  font-samarkan font-extrabold text-gray-100">
        ...
        <div className="w-full md:w-1/3 mb-6 md:mb-0">
          <h3 className="text-2xl text-center  font-bold text-gray-100 mb-4">
            Quick Links
          </h3>
